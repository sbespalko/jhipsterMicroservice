...
public class ProductResourceIT {
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getStartDt()).isEqualTo(DEFAULT_START_DT);
        assertThat(testProduct.getEndDt()).isEqualTo(DEFAULT_END_DT);
    }
    ...
    public void updateProduct() throws Exception {
        ...
        assertThat(testProduct.getStartDt()).isEqualTo(UPDATED_START_DT);
        assertThat(testProduct.getEndDt()).isEqualTo(UPDATED_END_DT);
    }
